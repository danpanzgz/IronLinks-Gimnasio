...
-- monitor, sala y plazas disponibles." Útil para el panel de
-- recepción cuando un socio pregunta qué clases hay libres.
-- ============================================================
SELECT
    c.nombre            AS clase,
    c.dia_semana,
...
-- pago." Ayuda a contabilidad a analizar cómo pagan los socios
-- y valorar si eliminar el cobro en efectivo.
-- ============================================================
SELECT
    p.metodo_pago,
    COUNT(*)            AS num_pagos,
...
-- la semana." Sirve para controlar la carga de trabajo de los
...
-- Básico y llevan más de 1 año en el gimnasio." Son candidatos
-- para una oferta de upgrade a tarifa Completa.
-- ============================================================
SELECT
    s.nombre || ' ' || s.apellidos  AS socio,
    s.email,
...
-- confirmadas (asistio='S')." Permite al equipo conocer qué
