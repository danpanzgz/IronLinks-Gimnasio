...
-- ============================================================
-- 2. Insertar inscripciones (ahora sí funcionarán)
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 1,  1, DATE '2025-01-12', 'S');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 1,  3, DATE '2025-01-12', 'S');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 2,  3, DATE '2025-03-06', 'S');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 2,  6, DATE '2025-03-06', 'P');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 3,  1, DATE '2025-01-20', 'S');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 4,  5, DATE '2025-04-21', 'P');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 6,  9, DATE '2025-02-11', 'S');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 6,  3, DATE '2025-02-11', 'S');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 7,  7, DATE '2025-06-02', 'P');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 7,  1, DATE '2025-06-02', 'P');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 8,  4, DATE '2025-01-10', 'S');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 8,  6, DATE '2025-01-10', 'S');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 10, 5, DATE '2025-09-04', 'P');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 11, 11,DATE '2025-01-01', 'S');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 12, 6, DATE '2025-08-20', 'P');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 13, 2, DATE '2024-03-01', 'S');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 14, 6, DATE '2025-03-16', 'S');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 15, 1, DATE '2025-01-08', 'P');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 1,  7, DATE '2025-02-01', 'S');
INSERT INTO IRONLINKS.inscripcion_clase VALUES (seq_inscripcion.NEXTVAL, 3,  9, DATE '2025-02-01', 'S');

COMMIT;


-- Luego actualizar plazas_libres manualmente para reflejar las inscripciones
-- (el trigger no pudo hacerlo al fallar los inserts originales)
UPDATE IRONLINKS.clase SET plazas_libres = plazas_max - 2 WHERE id_clase = 1;  -- 2 inscritos
UPDATE IRONLINKS.clase SET plazas_libres = plazas_max - 2 WHERE id_clase = 2;  -- 2 inscritos
UPDATE IRONLINKS.clase SET plazas_libres = plazas_max - 2 WHERE id_clase = 3;  -- 2 inscritos
UPDATE IRONLINKS.clase SET plazas_libres = plazas_max - 1 WHERE id_clase = 5;  -- 1 inscrito
UPDATE IRONLINKS.clase SET plazas_libres = plazas_max - 2 WHERE id_clase = 6;  -- 2 inscritos
UPDATE IRONLINKS.clase SET plazas_libres = plazas_max - 2 WHERE id_clase = 7;  -- 2 inscritos
UPDATE IRONLINKS.clase SET plazas_libres = plazas_max - 2 WHERE id_clase = 8;  -- 2 inscritos
UPDATE IRONLINKS.clase SET plazas_libres = plazas_max - 2 WHERE id_clase = 9;  -- 2 inscritos
UPDATE IRONLINKS.clase SET plazas_libres = plazas_max - 1 WHERE id_clase = 11; -- 1 inscrito

-- Para que la consulta 6 tenga resultados visibles, metemos clases casi llenas
-- Clase 9 (Natación Adultos, 10 plazas): dejamos solo 2 libres = 20% libre
UPDATE IRONLINKS.clase SET plazas_libres = 2 WHERE id_clase = 9;
-- Clase 10 (Aqua Aeróbic, 10 plazas): dejamos solo 1 libre = 10% libre  
UPDATE IRONLINKS.clase SET plazas_libres = 1 WHERE id_clase = 10;
-- Clase 7 (Kickboxing Básico, 16 plazas): dejamos 4 libres = 25% libre
UPDATE IRONLINKS.clase SET plazas_libres = 4 WHERE id_clase = 7;
